...
fun ScreenContent(katalog: Katalog, modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            trailingIcon = { IconPicker(lebarDadaError, "kg") },
...
private fun getLategori(lebarDada: Float, panjangTubuh: Float, lengan: Boolean): Int {
    return if (lengan) {
        when {
            lebarDada >= 58 || panjangTubuh >= 75 -> R.string.Ukuran_xxxl
            lebarDada >= 56 || panjangTubuh >= 75 -> R.string.Ukuran_xxl
            lebarDada >= 54 || panjangTubuh >= 74 -> R.string.Ukuran_xl
...
fun MainScreen(navController: NavHostController) {
    ...
    Scaffold(
        ...
        ScreenContent(katalog = katalog_kategori, Modifier.padding(innerPadding))
    }
}
